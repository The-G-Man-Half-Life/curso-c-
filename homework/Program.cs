...
// string result = extraContent + sentence.Substring(position-1);
...
//10
// string chain1 = "Hola"
// string chain2 = "tonotos"

// Console.WriteLine($"{chain1} + {chain2}")
//11
// int number = 3;
...
// string resultado = char.ToUpper(textoSinEspacios[0]) + textoSinEspacios.Substring(1).ToLower();

// Console.WriteLine($"Texto formateado: {resultado}");
//15
// Console.Write("Ingrese un numero cualquiera: ")
...
// string result = chain1 + chain2 + chain3;

// Console.WriteLine($"Cadena 1: {chain1}, Longitud: {chain1.Length}");
// Console.WriteLine($"Cadena 2: {chain2}, Longitud: {chain2.Length}");
// Console.WriteLine($"Cadena 3: {chain3}, Longitud: {chain3.Length}");
// Console.WriteLine($"Resultado: {result}, Longitud total: {result.Length}");
//17
// string mensaje = "¡Hola mundo!";
// string subcadena = mensaje.Substring(5, 4);
// Console.WriteLine($"Subcadena: {subcadena}, Longitud: {subcadena.Length}");